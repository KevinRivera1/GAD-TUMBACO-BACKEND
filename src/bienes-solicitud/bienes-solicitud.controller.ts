...
export class BienesSolicitudController {
  constructor(
    private readonly bienesSolicitudService: BienesSolicitudService,
  ) {}
  ...
  @ApiResponse({
    status: 200,
    description: 'Todos los registros de bienes-solicitud.',
  })
  @Get('all')
  findAll() {
  ...
  updateSolicitud(
    @Param('id') id: string,
    @Body() updateBienesSolicitudDto: UpdateBienesSolicitudDto,
  ) {
  ...
  @ApiOperation({
    summary: 'Eliminado logico de un registro de bienes-solicitud',
  })
  @ApiResponse({
    status: 200,
    description: 'Registro eliminado logicamente de forma correcta.',
  })
  ...
  @ApiOperation({
    summary: 'Restauracion logica de un registro de bienes-solicitud',
  })
  @ApiResponse({
    status: 200,
    description: 'Registro restaurado logicamente de forma correcta.',
  })
  @Patch('restore/:id')
