...
@Module({
    imports: [
      ...
      TypeOrmModule.forFeature([Usuario,EstadosEntity,RolesEntity, UsuariosRepository])],
    controllers: [UsuariosController],
    providers: [UsuariosService, UsuariosRepository, JwtStrategy, EncoderService, EmailService],
