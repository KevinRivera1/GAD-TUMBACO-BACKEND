...
export class PresidenciaController {
  ...
  @Put('update/:id')
  updatePresidencia(@Param('id') id: string, @Body() updatePresidenciaDto: UpdatePresidenciaDto) {
  ...
  @ApiResponse({ status: 200, description: 'Elemento actualizado correctamente' })
  @Patch(':id')
  update(@Param('id') id: string, @Body() updatePresidenciaDto: UpdatePresidenciaDto) {
    return this.presidenciaService.update(+id, updatePresidenciaDto);
  }
